            ...
            <div class="section">
                ...
                <div class="form">
                    ...
                    <div class="mdui-textfield mdui-textfield-not-empty">
                        ...
                        <input class="mdui-textfield-input" name="dbname" value="questionbox">
                    </div>
                    <div class="mdui-textfield mdui-textfield-not-empty">
                        <label class="mdui-textfield-label">用户名</label>
                        <input class="mdui-textfield-input" name="dbuser" value="questionbox">
                    </div>
                    ...
                    <div class="mdui-textfield mdui-textfield-not-empty mdui-textfield-has-bottom">
                        ...
                        <input class="mdui-textfield-input" name="dbprefix" value="qb_" autocomplete="off">
                        <div class="mdui-textfield-helper">如果您希望在同一个数据库安装多个提问箱, 请修改前缀</div>
                    </div>
                </div>
            </div>
            <div class="section">
                ...
                <div class="form">
                    ...
                    <div class="mdui-textfield">
                        ...
                        <input class="mdui-textfield-input" name="sitetitle" value="我的提问箱"/>
                    </div>
                    
                    <div class="mdui-textfield">
                        <label class="mdui-textfield-label">站点描述</label>
                        <input class="mdui-textfield-input" name="describe" value="这是我的提问箱，欢迎大家提问"/>
                    </div>
